...
function CheckIcon({size = 14, color = colors.primary}: {size?: number; color?: string}) {
  return (
...
export default function HomeScreen() {
  ...
  const formatNumber = useCallback(
    (num: number) => (i18n.language === 'ar' ? toArabicNumerals(num) : String(num)),
    [i18n.language],
  );
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView
        ...
        <View style={styles.greetingBlock}>
          <Typography variant="body" family="cairo" color="muted" style={styles.dateLabel}>
            {todayDate}
          </Typography>
          <Typography variant="h1" family="amiriBold" style={styles.greeting}>
            {t('home.greeting')}
            {'،\n'}
            {user?.name ? (
              <Typography variant="h1" family="amiriBold" style={styles.greetingName}>
                {user.name}
              </Typography>
            ) : null}
          </Typography>
              ...
              <View style={styles.wardCardInner}>
                <Animated.View
                  ...
                  <Typography
                    ...
                    family="cairo"
                    weight="semibold"
                    style={isCompleted ? styles.statusTextCompleted : styles.statusTextPending}>
                    {isCompleted ? t('home.statusCompleted') : t('home.statusPending')}
                  </Typography>
                </Animated.View>

                <Typography variant="h1" family="amiriBold" style={styles.wardCardSurahName}>
                ...
                <View style={styles.statsRow}>
                  <View style={styles.statCol}>
                    <Typography variant="small" family="cairo" color="muted" style={styles.statLabel}>
                      {t('home.stats.ayahCount')}
                    </Typography>
                    <Typography variant="body" family="cairo" weight="semibold" style={styles.statValue}>
